...
* **Gallery Ratings Button** - Choose for your visitors how to rate your images with Heart button or Like/Dislike button. If do not need to rate your gallery images then just put OFF.
...
* **Gallery Image size** - In general settings of the gallery you can change the main image width, Image Border Width, Color, and Radius.

* **Gallery Navigation Arrow** - Image Gallery allows you to set the most appropriate navigation arrows, which will suit the best for your images in your gallery. 
...
* Similar boxes for every image in gallery
...
* Image Border Width: Set the width of borders of the gallery  image 
* Image Border Color: Choose the color for border of the gallery images
* Border Radius: Choose the radius of border corners in the gallery images
...
* Title Background Color and Transparency: Choose the title background color and its transparency of the gallery images
...
*   **Title**
* Title Width: Choose the width for title box of the gallery images
...
= 1.7.3 =
*  More load images bug fixed in image gallery.
...
= 1.6.5 =
*  Rating system has been added in image gallery.
